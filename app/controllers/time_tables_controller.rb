class TimeTablesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @time_table.save
        format.html { redirect_to time_table_url(@time_table), notice: "Time table was successfully created." }
  ...
  def update
    respond_to do |format|
      if @time_table.update(time_table_params)
        format.html { redirect_to time_table_url(@time_table), notice: "Time table was successfully updated." }
  ...
  private
    ...
    def time_table_params
      params.require(:time_table).permit(:start_time)
    end
end
